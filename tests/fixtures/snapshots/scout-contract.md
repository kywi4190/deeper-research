...
# TASK
Scout the interpretability-research angle.

# INPUTS

### input: brief
```yaml
goal: Choose the senior research project
...
# BUDGET
You have 3 units (~36 searches). Enumerate first, then evidence.
